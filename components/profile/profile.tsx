  ...
  return (
    <section>
      ...
      <div className="max-w-5xl md:mx-auto rounded-lg shadow-2xl bg-white mx-2 bakhMedium dark:text-gray-700">
        ...
        <div className="mx-4 pr-2 md:w-1/3 text-center">
          <p>نام و نام خانوادگی</p>
          <div className="text-left">
            <input
              type="text"
              className="bg-white border-b border-dashed my-1 text-lg w-[70%] pr-2
              focus:bg-red-400"
          ...
          <button
            className="border border-blue-400 text-blue-400
                       rounded-md w-[35%] p-2 my-1 hover:bg-blue-50"
        ...
        <div className="md:w-2/3 md:mx-4">
          <p className="text-start mr-[40%] md:mx-4 md:mr-[120px] mt-4">آدرس</p>
          <div className="text-start  mr-[40%] md:mr-[120px] mt-2">
            {user.address == null ? (
            ...
            <button
              className="border border-blue-400 text-blue-400
                       rounded-md w-[20%] p-2 my-1 hover:bg-blue-50"
